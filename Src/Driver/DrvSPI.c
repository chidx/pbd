...
/*    eSpiPort    [in]: Specify the SPI port                                                               */
/*    bEnable     [in]: Enable (TRUE) / Disable (FALSE)                                                    */
/*    i32Interval [in]: In FIFO mode, it could be 2~15 and 0. 0 indicates the maximum suspend interval; 2  */
/*                      indicates the minimum suspend interval. Please refer to NUC1xx TRM for the actual  */
/*                      suspend interval.                                                                  */
/*                                                                                                         */
/* Returns:                                                                                                */
/*    E_DRVSPI_ERR_SUSPEND_INTERVAL: The suspend interval setting is out of range.                         */
...
/*                                                                                                         */
/* Description:                                                                                            */
/*    Enable/disable FIFO mode. If the caller enables FIFO mode, configure the setting of suspend cycle.   */
